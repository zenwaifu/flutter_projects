...
class _SubmitPetScreenState extends State<SubmitPetScreen> {
  ...
  // Dropdown lists
  final List<String> listOfPets = ['Dog', 'Cat', 'Rabbit', 'Other'];
  final List<String> listOfCategories = ['Adoption', 'Donation Request', 'Help/Rescue'];
  ...
  // images: use File for mobile, Uint8List for web
  List<File> imageFiles = []; // mobile
  ...
  Widget buildImagePreviewArea() {
    final imagesCount = kIsWeb ? webImages.length : imageFiles.length;
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          if (kIsWeb) {
            ...
            imageWidget = Image.file(imageFiles[index], fit: BoxFit.cover, width: 120, height: 120);
          }
